...
app.post("/sign_in_with_apple", async(request, response) => {
    const auth = new AppleAuth({
            ...
            client_id: request.query.useBundleId === "true" ?
                "com.the-coach.ios" : "com.the-coach.ios.service",
            team_id: "D77A5WLRQK",
            redirect_uri: "https://flutter-sign-in-with-apple-example.glitch.me/callbacks/sign_in_with_apple", // does not matter here, as this is already the callback that verifies the token after the redirection
            key_id: "G32H3533F6"
        },
        `-----BEGIN PRIVATE KEY-----|MIGTAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBHkwdwIBAQQgxMZR9NzzLRgBhJLh
        gmDBtEVruXNT+a6fDFzgnMsjZ2CgCgYIKoZIzj0DAQehRANCAASb7VeXTs6Oa7I7
        y7VhhHg1ZWNpSYxbnEWb2iq2teZ3Xte8UpThi1vUVHGs23g/gKYxQHTrzBx8puWh
        fClO6k7F|-----END PRIVATE KEY-----`.replace(/\|/g, "\n"),
        "text"
    );
